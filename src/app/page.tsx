...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground font-sans selection:bg-primary selection:text-white">
      ...
      <section className="w-full py-24 bg-background-alternate border-t border-border-color">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          ...
          <div className="rounded-[var(--radius-card)] overflow-hidden border border-border-color shadow-sm bg-background">
            <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-border-color">
              {/* Header Row */}
              <div className="hidden md:block p-6 bg-background-alternate font-semibold text-foreground">Feature</div>
              <div className="hidden md:block p-6 bg-background-alternate font-semibold text-foreground border-b border-border-color md:border-b-0">The Old Way ❌</div>
              ...
              {/* Row 1 */}
              <div className="p-6 md:p-6 bg-background-alternate md:bg-transparent font-medium md:font-normal text-foreground md:border-t border-border-color">
                <span className="md:hidden font-semibold mr-2">Feature:</span>
                Sharing AI HTML
              </div>
              <div className="p-6 text-foreground-muted bg-gray-50/50 dark:bg-gray-900/20 md:border-t border-border-color">
                <span className="md:hidden font-semibold mr-2 block mb-2 text-foreground">The Old Way ❌:</span>
                Sending raw <code className="text-sm bg-background-alternate px-1 py-0.5 rounded border border-border-color">.html</code> attachments or manual bucket configurations.
              </div>
              <div className="p-6 text-foreground bg-primary/5 md:border-t border-border-color">
                ...
                <code className="text-sm bg-primary/10 text-primary px-1 py-0.5 rounded border border-primary/20">serve-it deploy</code> to instantly get a secure live link.
              </div>
      ...
      <section className="w-full py-24 bg-background border-y border-border-color">
      ...
      <section id="architecture" className="w-full py-24 bg-background-alternate border-t border-border-color">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
      ...
      <section className="w-full py-24 bg-background border-t border-border-color">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="hover:shadow-md transition-shadow duration-300 group flex flex-col">
              ...
              <div className="flex-grow space-y-4">
                <div>
                  ...
                  <p className="text-foreground text-sm">Hosting raw HTML from Claude/ChatGPT requires complex setup.</p>
                </div>
                <div>
                  <span className="font-semibold text-primary block mb-1">Solution:</span>
                  <p className="text-foreground text-sm">Use <code className="text-xs bg-primary/10 text-primary px-1 py-0.5 rounded border border-primary/20">serve-it deploy</code> to instantly drop AI-generated tools into an enterprise-grade layer.</p>
                </div>
              </div>
            </Card>
            ...
            <Card className="hover:shadow-md transition-shadow duration-300 group flex flex-col">
              ...
              <div className="flex-grow space-y-4">
                <div>
                  <span className="font-semibold text-foreground-muted block mb-1">Problem:</span>
                  <p className="text-foreground text-sm">Sharing sensitive prototypes or data reports with external customers risks leaks.</p>
                </div>
                <div>
                  <span className="font-semibold text-primary block mb-1">Solution:</span>
                  <p className="text-foreground text-sm">Automatic enforcement of <strong>Entra ID authentication</strong> so only the intended clients view it.</p>
                </div>
              </div>
            </Card>
            ...
            <Card className="hover:shadow-md transition-shadow duration-300 group flex flex-col">
              ...
              <div className="flex-grow space-y-4">
                <div>
                  <span className="font-semibold text-foreground-muted block mb-1">Problem:</span>
                  <p className="text-foreground text-sm">Static assets can be silently tampered with or modified mid-flight.</p>
                </div>
                <div>
                  <span className="font-semibold text-primary block mb-1">Solution:</span>
                  <p className="text-foreground text-sm">Cryptographically signed deployments guarantee an unaltered single source of truth.</p>
                </div>
              </div>
            </Card>
          </div>
